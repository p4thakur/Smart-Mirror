...
weather_api_token = ""
wit_ai_token = "Bearer HBBRLJTMOHBC6JK5OD6XZCDHKC5R5SI6" #Bearer HBBRLJTMOHBC6JK5OD6XZCDHKC5R5SI6
...
class Bot(object):
    ...
    def __youtube_action(self, nlu_entities=None):
        video = None
        DEVELOPER_KEY = "AIzaSyCQizUpW2ALqVaZe8ZipfJbs-VqiCbHwEw"  #add developer key 
    ...
    def __zomato_action(self, nlu_entities=None):
        if nlu_entities is not None:
            if 'location' in nlu_entities:
                ...
                print entities
                response= requests.get('https://maps.googleapis.com/maps/api/geocode/json?address=%s&key=AIzaSyCQizUpW2ALqVaZe8ZipfJbs-VqiCbHwEw' %entities) #inset google maps key here
                print response
                ...
                header = {"Accept": "application/json", "user_key": "69c7810658c0ab0e36ba4d1a7fb8611f"}  #add user key
